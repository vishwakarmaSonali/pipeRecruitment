  ...
  return (
    <div className="flex h-screen">
      ...
      <h2 className="text-3xl font-medum font-ubuntu">Log In</h2>
        <p className="text-customGray font-ubuntu text-m mt-[6px] mb-[80px]">{"Welcome back! Log in to manage your recruitment \n workflow effortlessly."}</p>

        <div className="w-96 space-y-4">
          <div className="space-y-2">
          <label className="block text-customBlue font-ubuntu text-sm mb-1">Email Id</label>
          <CommonTextInput
            type="email"
        ...
        <div>
        <label className="block text-customBlue font-ubuntu text-sm mb-1">Password</label>
          ...
          <div className="text-right mt-2 text-customBlue font-ubuntu text-sm pb-[32px] ">
            <a href="#" className="text-buttonBLue text-sm">Forgot Password?</a>
          </div>
      ...
      <div className="flex justify-end">
          <p className="text-customBlue font-ubuntu text-sm text-center">
            Having any trouble? <a href="#" className="text-buttonBLue">Contact Us</a>
          </p>
        </div>
      </div>
    </div>
