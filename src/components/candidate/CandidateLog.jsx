  ...
  return (
    <div className="candidate-details-main-container">
      ...
      <div className="details-container">
        ...
        <div className="detail-row">
          <p className="font-14-medium color-dark-black flex-1">Created by:</p>
          <div className="display-flex flex-1 align-center" style={{ gap: 6 }}>
            <div className="w-h-26">
              <img src="" className="common-img" />
            </div>
            <p className="font-14-regular color-dark-black flex-1">xBoost</p>
          </div>
        </div>
        <div className="detail-row">
