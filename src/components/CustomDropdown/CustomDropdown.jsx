...
const CustomDropdown = ({ options, placeholder, selectedValues, onChange, optionKey, multiSelect = false, showCheckbox = false }) => {
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      <div className="w-full pr-2 border min-h-[38px] flex justify-between items-center bg-white border-customGrey1 rounded-[8px] text-sm text-customBlue placeholder:text-borderGrey">
        <input
          type="text"
